...
// //////////////////////////////////////////////////
// const obj2 = JSON.parse(JSON.stringify(obj1)); //с помощью этой строки произвели глубокое копирование/
...
// getSum("sum", 1, 2, 3, 4, 5, 7, 8, 9, 0);
// функция которая первым аргументом принимает действие (сумма, вычитание), после принимает параметры для
/////////////////////////////////////////////
// пример
// const getSum = (type, ...args) => {
//   if (type === "sum") {
...
//   console.log(arr[i]);
// }
// тоже самое что и в предидущей строке for
...
// ● Написать функцию которая будет принимать n-ое количество аргументов, в
...
// console.log(someArgs(1, 2, 3, -6, 2, 8, 9));
